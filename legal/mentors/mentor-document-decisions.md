...
**Purpose:** Central source for business decisions that should stay aligned across mentor-facing legal and onboarding drafts
...
- Current public tuition model:
  ...
  - **Research Extensions:** {{ site.data.pathways.research_extension.price }} per student
...
- VRI may require identity verification, reference review, publication/credential review, and background checks where appropriate
- Final activation should occur only after required documentation and review are complete
...
- VRI may consider enrollment level, student fit, mentor availability, scheduling feasibility, operational readiness, program balance, quality control, and business needs when deciding whether a proposal will run.
...
- Non-circumvention / no private side deals
- Non-solicitation / no-poaching
- Brand / template / workflow protection
- No unauthorized statements on behalf of VRI
- Proposal pipeline, enrollment leads, project demand information, unpublished proposal ideas, and VRI launch decisions should be treated as protected nonpublic business information unless VRI makes them public.
...
- Public wording should distinguish between:
  - being an approved mentor;
  - having a proposal listed publicly;
...
- VRI may limit, rotate, postpone, or rebalance mentor assignments to preserve program quality, avoid overextension, maintain a broad project slate, or respond to enrollment patterns.
