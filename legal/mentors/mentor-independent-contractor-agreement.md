---
layout: default
title: Mentor Independent Contractor Agreement
permalink: /legal/mentors/mentor-independent-contractor-agreement/
robots: noindex
sitemap: false
---

# Mentor Independent Contractor Agreement

**Document status:** Internal draft for business structuring and counsel review  
**Prepared for:** Virtual Research Institute LLC  
**Intended use:** Working draft for mentor contractor onboarding and legal review

---

## 1. Parties

This Mentor Independent Contractor Agreement (“Agreement”) is entered into by and between **Virtual Research Institute LLC (“VRI”)** and the individual mentor identified in the applicable signature block or onboarding materials (“Mentor”).

## 2. Purpose

The purpose of this Agreement is to define the terms under which Mentor may provide approved mentoring, instructional, project-guidance, or related scholarly services for VRI as an independent contractor.
...
The initial term of this Agreement shall be **{{ site.data.mentors.engagement_model.agreement_term }}**, unless earlier terminated in accordance with this Agreement.
...
Mentor may provide approved mentoring, instructional, project-guidance, research-supervision, review, presentation-preparation, or related scholarly services for VRI only as specifically authorized by VRI for a given term, cohort, project, or engagement.

Mentor is not entitled to offer services under the VRI name except in connection with approved VRI programming and within the scope authorized by VRI.

## 7. No Authority to Bind VRI

Mentor may not, without prior written authorization from VRI:

- bind VRI to any contract, promise, refund, representation, or obligation;
- modify VRI policies, payment terms, enrollment terms, or program rules;
- make public statements on behalf of VRI in an official capacity;
- offer admissions, placements, guarantees, or financial commitments in VRI’s name;
